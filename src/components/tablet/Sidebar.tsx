...
export function Sidebar() {
    return (
        <div className="h-screen w-16">
            <aside className="w-24 h-full bg-gray-100 border-gray-300 border-r dark:border-r-2 dark:bg-[#232c3d] dark:border-[#454f66]" aria-label="Sidebar">
                <div className="h-24 w-20 flex justify-center border-b border-gray-300 dark:border-b-2 dark:border-[#454f66]">
